...
[[block_local]] pa_scheduler::QkSplitRuntimeState pa_scheduler_qk_callback_state_aic;
__aicore__ void
pa_scheduler_qk_callback_orchestration_aic(__gm__ pa_scheduler::SchedulerState *state, uint32_t worker_id);
#elif defined(PA_BUILD_AIV)
[[block_local]] pa_scheduler::QkSplitRuntimeState pa_scheduler_qk_callback_state_aiv;
__aicore__ void
pa_scheduler_qk_callback_orchestration_aiv(__gm__ pa_scheduler::SchedulerState *state, uint32_t worker_id);
#else
...
extern "C" __global__ __aicore__ void pa_scheduler_0_mix_aic(__gm__ pa_scheduler::SchedulerState *state) {
    ...
    pa_scheduler_qk_callback_orchestration_aic(state, worker_id);
}
#elif defined(PA_BUILD_AIV)
...
extern "C" __global__ __aicore__ void pa_scheduler_0_mix_aiv(__gm__ pa_scheduler::SchedulerState *state) {
    ...
    pa_scheduler_qk_callback_orchestration_aiv(state, worker_id);
}
#endif
