...
inline HbgStaticExecutionSlotStatus prepare_hbg_static_execution_slot(
    ...
    if (api->setup_static_arena == nullptr || api->acquire_pooled_gm_heap == nullptr ||
        api->acquire_pooled_gm_sm == nullptr || api->acquire_pooled_runtime_arena == nullptr ||
        api->freeze_static_arena == nullptr) {
        return HbgStaticExecutionSlotStatus::MissingHostCapability;
    }
