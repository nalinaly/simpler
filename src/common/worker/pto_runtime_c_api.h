...
enum {
    ...
    PTO_RUNTIME_ERR_INVALID_ARGUMENT = -3,
    PTO_RUNTIME_ERR_INVALID_STATE = -4,
    PTO_RUNTIME_ERR_DEVICE_MISMATCH = -5,
    PTO_RUNTIME_ERR_RUNTIME_FAILURE = -6,
    PTO_RUNTIME_ERR_NOT_READY = -7,
};
